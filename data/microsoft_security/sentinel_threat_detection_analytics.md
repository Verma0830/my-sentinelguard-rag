# Microsoft Sentinel Analytics Rules & Incident Detection

Source URL: https://learn.microsoft.com/en-us/azure/sentinel/detect-threats-built-in
...
Anomalies don't necessarily indicate malicious or even suspicious behavior by themselves. Therefore, anomaly rules don't generate their own alerts. Rather, they record the results of their analysisâthe detected anomaliesâin the Anomalies table. You can query this table to provide context that improves your detections, investigations, and threat hunting.
...
For more information on how to enable this rule, see Use matching analytics to detect threats.For more information on MDTI, see What is Microsoft Defender Threat Intelligence.
...
Learn more about Scheduled analytics rules in Microsoft Sentinel and Quick threat detection with near-real-time (NRT) analytics rules in Microsoft Sentinel.

To find more rule templates, see Discover and manage Microsoft Sentinel out-of-the-box content.
